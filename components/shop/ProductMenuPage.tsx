...
const menuSectionContent: Record<string, ProductSectionContent> = {
  ...
  ghi: {
    badge: "খাঁটি দেশি ঘি’র নির্বাচিত সংগ্রহ",
    heading: "ঘ্রাণ, স্বাদ, বিশুদ্ধতা আর পরিবারের নিয়মিত ব্যবহারভিত্তিক",
    highlightedHeading: "আমাদের মানসম্মত দেশি ঘি’র সংগ্রহ",
    description:
      "রান্না, ভর্তা, খিচুড়ি, পোলাও বা মিষ্টি খাবারের স্বাদ বাড়াতে খাঁটি ঘি’র আলাদা গুরুত্ব আছে। তাই ঘ্রাণ, রং, গঠন, প্যাকেজিং এবং দৈনন্দিন ব্যবহারের সুবিধা বিবেচনা করে এই ঘি সংগ্রহ সাজানো হয়েছে।",
    noteLabel: "ঘি নির্বাচনের কথা",
    note:
      "ভালো ঘি কেনার সময় ঘ্রাণ, স্বাভাবিক দানাদার গঠন, রং এবং সংরক্ষণযোগ্যতা সবচেয়ে জরুরি। আমরা এমন ঘি রাখতে চাই যা পরিবারের নিয়মিত রান্না, অতিথি আপ্যায়ন এবং উপহার দেওয়ার জন্য সহজে মানিয়ে যায়।",
  },
  honey: {
